...
lvim.builtin.which_key.mappings["m"] = {
  ...
  ["7"] = { "<cmd>lua require('harpoon.ui').nav_file(7)<cr>", "Navigate to 7th mark file" },
  ["8"] = { "<cmd>lua require('harpoon.ui').nav_file(8)<cr>", "Navigate to 8th mark file" },
  ["9"] = { "<cmd>lua require('harpoon.ui').nav_file(9)<cr>", "Navigate to 9th mark file" },
  ["0"] = { "<cmd>lua require('harpoon.ui').nav_file(0)<cr>", "Navigate to 10th mark file" },
...
lvim.builtin.which_key.mappings["s"] = {
  ...
  R = { "<cmd>Telescope resume<cr>", "Resume previous telescope command" },
...
lvim.builtin.which_key.mappings["t"] = {
  ...
  H = { "<cmd>tabfirst<cr>", "Navigate to first tab" },
