...
vim.keymap.set({'n', 't'}, '<C-h>', '<CMD>lua require("smart-splits").move_cursor_left<CR>')
vim.keymap.set({'n', 't'}, '<C-l>', '<CMD>lua require("smart-splits").move_cursor_right<CR>')
vim.keymap.set({'n', 't'}, '<C-k>', '<CMD>lua require("smart-splits").move_cursor_up<CR>')
vim.keymap.set({'n', 't'}, '<C-j>', '<CMD>lua require("smart-splits").move_cursor_down<CR>')
